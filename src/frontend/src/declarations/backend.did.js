...
export const TrainingInput = IDL.Record({
...
export const EnrollmentInput = IDL.Record({
  'name' : IDL.Text,
  'email' : IDL.Text,
  'trainingId' : Id,
  'phone' : IDL.Text,
...
export const QuoteInput = IDL.Record({
  'customerName' : IDL.Text,
  'serviceType' : IDL.Text,
  'email' : IDL.Text,
  'phone' : IDL.Text,
...
export const idlService = IDL.Service({
  ...
  'adminUpdateQuoteStatus' : IDL.Func([Id, QuoteStatus], [IDL.Opt(Quote)], []),
  ...
  'listProperties' : IDL.Func([PropertyFilter], [IDL.Vec(Property)], ['query']),
