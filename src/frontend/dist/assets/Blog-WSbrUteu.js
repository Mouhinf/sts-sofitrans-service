...
import { h as commonjsGlobal, i as getDefaultExportFromCjs, k as React, r as reactExports, j as jsxRuntimeExports, a as cn, B as Button, e as ue } from "./index-CtugyttR.js";
...
import { L as Label, I as InputField } from "./InputField-FRvVB7Ym.js";
...
import { x as useAdminBlogPosts, y as useAdminCreateBlogPost, z as useAdminUpdateBlogPost, A as useAdminDeleteBlogPost } from "./useBackend-DJ1gFwav.js";
...
function RichTextEditor({
  ...
  const labelId = reactExports.useMemo(
    () => label == null ? void 0 : label.toLowerCase().replace(/\s+/g, "-"),
    [label]
  );
...
function slugify(s) {
  return s.toLowerCase().normalize("NFD").replace(new RegExp("\\p{M}", "gu"), "").replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
}
function toInput(f) {
  return {
    title: f.title,
    ...
    categoryTags: f.tags.split(",").map((t) => t.trim()).filter(Boolean),
    featuredImage: f.featuredImage,
    publishDate: f.publishDate ? BigInt(new Date(f.publishDate).getTime() * 1e6) : void 0
  };
}
function validate(f) {
  const errors = {};
...
function AdminBlogPage() {
  ...
  const openEdit = (p) => {
    ...
    setForm({
      ...
      publishDate: p.publishDate ? new Date(Number(p.publishDate) / 1e6).toISOString().split("T")[0] : "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editTarget) {
        ...
        ue.success("Article mis à jour");
      } else {
        await createMutation.mutateAsync(input);
        ue.success("Article créé");
      }
      setModalOpen(false);
    } catch {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminLayout, { title: "Blog", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: openCreate, "data-ocid": "add-blog-btn", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/50 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-3 font-medium text-muted-foreground hidden md:table-cell", children: "Slug" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-3 font-medium text-muted-foreground hidden md:table-cell", children: "Statut" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-3 font-medium text-muted-foreground hidden lg:table-cell", children: "Date pub." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right p-3 font-medium text-muted-foreground", children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        isLoading ? ["r0", "r1", "r2", "r3"].map((rk) => /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { className: "border-b border-border", children: ["c0", "c1", "c2", "c3", "c4"].map((ck) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }) }, ck)) }, rk)) : posts == null ? void 0 : posts.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            className: "border-b border-border last:border-0 hover:bg-muted/20 transition-colors",
            "data-ocid": `admin-post-${p.id}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 font-medium text-foreground max-w-[200px] truncate", children: p.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-muted-foreground hidden md:table-cell font-mono text-xs max-w-[140px] truncate", children: p.slug }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 hidden md:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
                {
                  variant: p.postStatus === "published" ? "default" : "secondary",
                  className: p.postStatus === "published" ? "bg-primary/10 text-primary border-primary/20" : "",
                  children: p.postStatus === "published" ? "Publié" : "Brouillon"
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-3 text-muted-foreground hidden lg:table-cell text-xs", children: p.publishDate ? formatDate(p.publishDate) : "—" }),
        ...
        !isLoading && !(posts == null ? void 0 : posts.length) && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "td",
          {
            colSpan: 5,
            className: "p-8 text-center text-muted-foreground",
            "data-ocid": "empty-admin-posts",
            children: "Aucun article. Créez-en un !"
          }
        ) })
      ] })
    ] }) }) }),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium text-foreground mb-1.5", children: [
                    "Contenu ",
                  ...
                  errors.content && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive mt-1", children: errors.content })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ImageUpload,
                  ...
                  errors.featuredImage && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive mt-1", children: errors.featuredImage })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  InputField,
                  {
